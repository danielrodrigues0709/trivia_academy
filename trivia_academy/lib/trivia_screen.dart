...
class _TriviaScreenState extends State<TriviaScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:  AppBar(
        centerTitle: true, // https://stackoverflow.com/questions/43981406/how-to-center-the-title-of-an-appbar
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16,),
                Text(questionList[index].questionText, style: TextStyle(fontSize: 18),),
              ]
            ),
          ),
              ...
              child: FlatButton(
                onPressed: () {
                  ...
                  if(index < questionList.length-1) {
                    ...
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ScoreScreen(maximum: questionList.length, result: score,)),
                    );
                  }
                },
                child: Text(
